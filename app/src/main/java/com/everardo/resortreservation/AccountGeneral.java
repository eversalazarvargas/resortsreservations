...
/**
 * @author everardo.salazar on 1/31/19
 */
public final class AccountGeneral {
     ...
     */
    private static final String ACCOUNT_TYPE = "com.everardo.resortreservation";
    ...
    public static void createSyncAccount(Context c) {
        ...
        if (manager.addAccountExplicitly(account, null, null)) {
            ...
            final long SYNC_FREQUENCY = 3 * 60; // 1 hour (seconds)
